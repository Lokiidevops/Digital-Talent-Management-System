      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-6">
            {[
              { user: "John Doe", action: "completed task", target: "UI Redesign", time: "2 hours ago", initial: "JD", color: "blue" },
              { user: "Sarah Smith", action: "created new task", target: "API Integration", time: "4 hours ago", initial: "SS", color: "green" },
              { user: "Mike Johnson", action: "commented on", target: "Bug Report #102", time: "Yesterday", initial: "MJ", color: "purple" },
            ].map((activity, i) => (
              <div key={i} className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 pb-4 last:border-0 last:pb-0">
                <div className="flex items-center gap-4">
                  <div className={`h-10 w-10 rounded-full bg-${activity.color}-100 dark:bg-${activity.color}-900/30 flex items-center justify-center text-${activity.color}-600 dark:text-${activity.color}-400 font-bold`}>
                    {activity.initial}
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-900 dark:text-white">
                      <span className="font-bold">{activity.user}</span> {activity.action}{" "}
                      <span className="text-primary-600 dark:text-primary-400 font-semibold">{activity.target}</span>
                    </p>
